...
// 				"Биринчи классқа кабыл алуу үчүн кандай документтер керек?"
// 			),
// 			disc: t(
...
// 									boxShadow={
// 										isOpen ? "rgba(0, 0, 0, 0.35) 0px 5px 15px" : "none"
// 									}>
...
// 										alignItems={isOpen ? { md: "center", base: "start" } : { md: "center", base: "center" }}
// 										p="15px 30px"
// 										w={10}>
// 										<Icon
// 											as={isOpen ? AiOutlineMinus : IoAdd}
// 											color="black"
// 											fontSize={30}
// 											fontWeight={200}
// 										/>
